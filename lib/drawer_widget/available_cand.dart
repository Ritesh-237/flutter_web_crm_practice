...
class AvailableCandidates extends StatefulWidget {
  const AvailableCandidates({super.key});

  @override
  State<AvailableCandidates> createState() => _AvailableCandidatesState();
}

class _AvailableCandidatesState extends State<AvailableCandidates> {
