...
class JobleftCandidates extends StatefulWidget {
  const JobleftCandidates({super.key});

  @override
  State<JobleftCandidates> createState() => _JobleftCandidatesState();
}

class _JobleftCandidatesState extends State<JobleftCandidates> {
